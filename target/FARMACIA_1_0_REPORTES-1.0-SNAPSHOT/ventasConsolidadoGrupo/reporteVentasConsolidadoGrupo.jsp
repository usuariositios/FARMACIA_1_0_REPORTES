...
<html>
    <head>
        ...
        <title>Ventas consolidado por grupo de producto</title>
    ...
    <body>
                ...
                format.applyPattern("#,##0.00");
                    ...
                    String codGrupo = request.getParameter("codSubGrupo");
                ...
                %>
                <h3 align="center" class="outputText2">REPORTE VENTAS CONSOLIDADO POR GRUPO</h3>
            <br>
            <form>
             ...
             <%
                     ...
                     String consulta = " SELECT g.nombre_grupo_producto ,sum(sd.cant_salida) cant_salida,"
                             + " sum(sd.monto_sub_total) monto_sub_total,sum(sd.porc_descuento/100*sd.monto_sub_total) monto_descuento,"
                             + " sum(sd.monto_total) monto_total,sum( sd.cant_salida*sd.costo_unitario) monto_esperado,em.cod_empresa,sum(s.monto_amortizado) monto_amortizado"
                             ...
                             + " where 0=0 and f.fecha_factura"
                             + " between '"+fechaInicio+"' and '"+fechaFinal+"' and em.cod_empresa='"+codEmpresa+"'"                             
                             + " and sd.cod_producto in("+codProducto+") ";
                     
                     
                     
                     
                     consulta+=" group by g.nombre_grupo_producto,em.cod_empresa  order by g.nombre_grupo_producto asc ";
