...
<html>
    <head>
        ...
        <title>Reporte kardex de movimiento</title>
    ...
    <body>
                ...
                %>
                <h3 align="center" class="outputText2">REPORTE KARDEX DE MOVIMIENTO</h3>
            <br>
            <form>
             ...
             <%
                     ...
                     String consulta = "SELECT * FROM(		"
                             ...
                             + " ia.nro_ingreso_venta nro,iad.cant_ingreso,0 cant_salida,u.abreviatura"
                             ...
                             + " WHERE"
                             + " iad.cod_producto IN ("+codProducto+") AND ia.cod_almacen_venta = '"+codAlmacenVenta+"'	AND ia.fecha_ingreso_venta >= '"+fechaInicio+" 00:00:00' AND ia.fecha_ingreso_venta <= '"+fechaFinal+" 23:59:59' and ia.cod_estado_ingreso_venta = 1 "
                             + " UNION ALL"
                             + " SELECT s.fecha_salida_venta,	'Salida', td.cod_campo,	td.nombre_campo, s.nro_salida_venta,0,	sd.cant_salida,	u.abreviatura"
                             ...
                             + " WHERE 	sd.cod_producto IN ("+codProducto+") AND s.cod_almacen_venta = '"+codAlmacenVenta+"' AND s.fecha_salida_venta >= '"+fechaInicio+" 00:00:00' AND s.fecha_salida_venta <= '"+fechaFinal+" 23:59:59' and s.cod_estado_salida_venta = 1 "
                     ...
                     out.print("<tr>"
                                 ...
                                 + "<th class='bordeArriba bordeIzquierdo bordeAbajo bordeDerecho'>SALDO</th>"                                 
                                 + "</tr>");
                         ...
                         while(rs1.next()){
                             ...
                             out.print("<tr >"
                                     ...
                                     + "<td class='bordeIzquierdo bordeDerecho'>"+format.format(saldo) +" " + rs1.getString("abreviatura")+"</td>"
                                     + "</tr>");
                         }
                         out.print("<tr>"
